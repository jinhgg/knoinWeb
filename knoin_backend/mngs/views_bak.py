...
class StartAnalysView(APIView):
    ...
    def post(self, request, format=None):
        ...
        sections = 'fastp,classify,classifycal,fasta,classifyg,classifygcal,fastag,res,autoscreen'
        sam_ini_str = render({
...
class UpdateStateView(APIView):
    ...
    def post(self, request):
        ...
        if not os.listdir(collection_result_dir + '/classifyg'):
            # 没有分析完成的情况
...
class GenReportView(APIView):
    ...
    def post(self, request):
        ...
        age_luo = age[:-1]
        diagnosis = parse_diagnosis(project.diagnosis, project.clinical_manifestations)
